...
learn_file = '/sons/rwc/rwc-g-m02/1_32.wav';
test_file = '/sons/rwc/rwc-g-m02/1_32.wav';
[learn_feats_all, learn_magspecs_all, ref_learn_data] = load_data_one_file_melspec(learn_file, params.sr, params.sigma, params);
...
%     [test_feats_all, test_magspecs, n_f_test, ref_t_data, test_files] = load_yaafedata(params);
    params.startpoint = 1000000;
    [test_feats_all, test_magspecs, ref_t_data] = load_data_one_file_melspec(learn_file, params.sr, params.sigma, params);
...
parameters
save(['BigExpeMusic_results_' num2str(max(nb_learns)) '_for_' audio_file_path(end-16:end) '_' num2str(nb_trials) 'trials.mat'], ...
