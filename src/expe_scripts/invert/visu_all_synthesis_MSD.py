...
def save_fig_audio(rec_sig, audio_path, fig_path, target_name, format=(8,4), max_t=25):
    ...
    plt.savefig(os.path.join(fig_path, '%s.png'%target_name))
...
save_fig_audio(sig_cross_plain_piano,
               recons_audio_path,
               recons_fig_path,
               "cross_plain_piano")
...
save_fig_audio(sig_cross_plain,
               recons_audio_path,
               recons_fig_path,
               "cross_plain")
...
save_fig_audio(sig_cross_normalized_piano,
               recons_audio_path,
               recons_fig_path,
...
save_fig_audio(sig_cross_normalized,
               recons_audio_path,
               recons_fig_path,
               "cross_normalized")
...
save_fig_audio(sig_cross_penalized,
               recons_audio_path,
               recons_fig_path,
               "cross_penalized")
